    ...
    for (let i = 1; i <= totalImages; i++) {
        ...
        *  and, description for each image down inside div with id='img-content' */
        let elem = "<div class='col-md-3'>" +
            "<img id='training_" + i + "' data-toggle='modal' data-target='#showPhotoDetail' class='gallery-img' src='img/photo_gallery/training/gallery/training_" + i + ".jpg' alt='training " + i + "' data-heading='training " + i + "'/>" +
